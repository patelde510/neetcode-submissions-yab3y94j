class Solution {
    ...
    private void backtrack(List<Integer> nums, int target, int i, List<Integer> cur) {
        ...
        // This means it has more than one occurance of the same number. 
        // Can continue searching with same value
        ...
        // We eventually search with the next value in the list as well.
